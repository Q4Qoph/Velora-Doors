...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo2-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Apr 2026 02:33:05 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400;600&family=Cormorant+Garamond:ital,wght@0,300;1,300;1,400&display=swap" rel="stylesheet">
...
<body style="overflow: hidden; height: 100vh;">
    ...
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg velora-navbar">
        <div class="container-fluid velora-nav-inner">
            <!-- Logo -->
    ...
    <header class="header slider-fade">
        ...
        <div class="reservation">
            <a href="https://wa.me/254XXXXXXXXX" target="_blank">
                ...
                <div class="call"><span>WhatsApp Us</span> <br>Get in Touch</div>
            </a>
        </div>
    </header>
    ...
    <script src="{{ asset('assets/js/jquery-migrate-3.5.0.min.js') }}"></script>
